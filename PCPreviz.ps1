...
# Start a new PowerShell process with inherited admin rights
$scriptPath = Join-Path $PSScriptRoot "WU.ps1"
Start-Process powershell.exe -ArgumentList "-NoProfile -ExecutionPolicy Bypass -File `"$scriptPath`"" -Verb RunAs

Write-Host "Windows Update check initiated in a new window." -ForegroundColor Green
